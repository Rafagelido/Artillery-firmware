...
#define STRING_CONFIG_H_AUTHOR "Rafael Diaz" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Artillery Genius Rafa"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 450.2 }
